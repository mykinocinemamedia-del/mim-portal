  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold">Video Kursus</h1>
          <p className="text-muted-foreground mt-1">
            Tonton panduan dan tip untuk majikan pembantu rumah.
          </p>
        </div>
      ...
      {/* Overall Progress */}
      <Card className="border-0 shadow-md bg-gradient-to-br from-amber-50 to-emerald-50/30">
        <CardContent className="p-4">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-sm font-semibold text-amber-700">{overallPct}%</span>
          </div>
