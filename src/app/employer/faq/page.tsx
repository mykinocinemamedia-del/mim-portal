...
const DEFAULT_EMPLOYER_FAQS = [
  ...
  {
    id: 'default-employer-4',
    title: 'Bagaimana saya membayar gaji pembantu?',
    content:
      'Gaji pembantu dibayar melalui admin MIM Portal. Anda akan menerima notifikasi pembayaran setiap bulan. Hubungi admin melalui WhatsApp untuk membuat pembayaran.',
  },
  {
    id: 'default-employer-5',
    title: 'Bolehkah saya menamatkan kontrak lebih awal?',
    content:
      'Ya, anda boleh menamatkan kontrak lebih awal dengan memberi notis 30 hari. Sila hubungi admin untuk proses penamatan kontrak.',
  },
]
...
const DEFAULT_HELPER_FAQS = [
  ...
  },
  {
    ...
    content:
      'Jadual kerja boleh dilihat di menu "Jadual Kerja" dalam dashboard pembantu. Majikan atau admin akan menetapkan jadual untuk anda.',
  },
]

export default async function EmployerFaqPage() {
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription className="text-xs">
                  Panduan untuk majikan pembantu rumah, pengasuh, dan penjaga orang tua
                </CardDescription>
              </div>
            </div>
          </CardHeader>
                ...
                <AccordionItem key={faq.id} value={`employer-${faq.id}`}>
                  <AccordionTrigger className="text-sm hover:no-underline">
                    <span className="flex items-start gap-2">
                      <Badge
                        variant="outline"
                        className="rounded-full h-5 min-w-5 px-1.5 text-xs justify-center shrink-0 mt-0.5"
                      >
                        {i + 1}
                      </Badge>
          ...
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription className="text-xs">
                  Untuk rujukan - bagaimana pihak pembantu beroperasi
                </CardDescription>
              </div>
            </div>
          </CardHeader>
